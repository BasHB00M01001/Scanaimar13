...
echo "ARBITRARY";  
echo
curl -ks https://$1 -L -H 'accept: json' -H 'User-Agent: Mozilla/5.0' -I  -X ARBITRARY | cat > "$output_dir/curlg8.txt"
echo
...
echo
nmap $1 -sV -Pn -p80,81,443,4443,7443,8000,8080,8081,8443,8888 --script=http-enum --script=http-security-headers --script=http-methods --open -sCV -O | cat > "$output_dir/nmap1.txt"
echo
...
echo
arjun -u https://$1 | cat > "$output_dir/arjun.txt"
echo
...
echo
sitadel https://$1 -r 2  | cat > "$output_dir/sitadel.txt"
echo
echo -e "\e[00;35m# Web scanning with Wascan #\e[00m" 
echo
wascan --url https://$1 --scan 4 -v  | cat > "$output_dir/wascan.txt"
echo
echo -e "\e[00;35m# Scan magento with magescan #\e[00m"
echo
magescan scan:all  http://$1 --show-modules -k | cat > "$output_dir/magescan.txt"
echo
echo -e "\e[00;35m# Testing several attacks with webxploiter  #\e[00m" 
echo
webxploiter -u  https://$1 -a | cat > "$output_dir/webxploiter.txt"
echo
echo -e "\e[00;35m# Detect XSS vulnerabilities with xsstrike  #\e[00m" 
echo
xsstrike -u  https://$1 --blind --crawl -l 3  | cat > "$output_dir/xsstrike.txt"
echo
...
echo
nmap -p443 --script ssl-heartbleed -Pn $1 | cat > "$output_dir/nmapCVh.txt"
nmap -p443 --script ssl-poodle -Pn $1 | cat > "$output_dir/nmapCVp.txt"
nmap -p443 --script ssl-ccs-injection -Pn $1 | cat > "$output_dir/nmapCVin.txt"
nmap -p443 --script ssl-enum-ciphers -Pn $1 | cat > "$output_dir/nmapCVcip.txt"
nmap -p443 --script ssl-dh-params -Pn $1 | cat > "$output_dir/nmapCVpar.txt"
nmap  -sVC --script=cve-2021-41773.nse | cat > "$output_dir/nmapCV21.txt"
nmap  -sVC --script=phpadmin.nse $1 | cat > "$output_dir/nmapCVadm.txt"
nmap  -sVC --script=htpasswd.nse $1 | cat > "$output_dir/nmapCVpas.txt"
nmap  -sVC --script=traversal.nse $1 | cat > "$output_dir/nmapCVtras.txt"
nmap  -sVC --script=CVE-2024-3400.nse $1 | cat > "$output_dir/nmapCV24.txt"
nmap  -sVC --script=CVE-2023-36845.nse $1 | cat > "$output_dir/nmapCV23.txt"
nmap  -sVC --script=CVE-2023-27350.nse $1| cat > "$output_dir/nmapCV23-27.txt"
nmap  -sVC --script=CVE-2023-20198.nse $1| cat > "$output_dir/nmapCV23-20.txt"
nmap  -sVC --script=CVE-2023-6553.nse $1| cat > "$output_dir/nmapCV23-63.txt"
nmap  -sVC --script=cve-2022-40684.nse $1| cat > "$output_dir/nmapCV22-40.txt"
nmap  -sVC --script=CVE-2022-39952.nse $1| cat > "$output_dir/nmapCV22-39.txt"
nmap  -sVC --script=CVE-2022-22965.nse $1| cat > "$output_dir/nmapCV22-22.txt"
nmap  -sVC --script=f5.nse $1| cat > "$output_dir/nmapCVf5.txt"
nmap  --script=CVE-2019-19781.nse $1| cat > "$output_dir/nmapCV19.txt"
nmap -sVC --script=citrix.nse $1| cat > "$output_dir/nmap.txt"
echo
echo -e "\e[00;35m#Search for vulnerable with Kit Golismero #\e[00m" 
echo
golismero -e dns_malware scan https://$1 | cat > "$output_dir/golis.txt"
golismero -e heartbleed scan https://$1  | cat > "$output_dir/golisme.txt"
golismero -e brute_url_predictables scan https://$1 | cat > "$output_dir/golismoe.txt"
golismero -e brute_directories scan https://$1 | cat > "$output_dir/golissme.txt"
golismero -e sqlmap scan https://$1/index,php?id=* | cat > "$output_dir/golisme.txt"
golismero -e sslscan scan https://$1 | cat > "$output_dir/golismeo.txt"
golismero -e zone_transfer scan https://$1 | cat > "$output_dir/ggolismeo.txt"
...
echo
golismero -e fingerprint_web scan https://$1 | cat > "$output_dir/golismero2.txt"
echo
...
echo
nikto -Plugins 'apache_expect_xss' -host https://$1 | cat > "$output_dir/nikto.txt"
nikto -Plugins 'subdomain' -host https://$1 | cat > "$output_dir/nikto1.txt"
nikto -Plugins 'shellshock' -host https://$1 | cat > "$output_dir/nikto2.txt"
nikto -Plugins 'cookies' -host https://$1 | cat > "$output_dir/nikto3.txt"
nikto -Plugins 'put_del_test' -host https://$1
nikto -Plugins 'headers' -host https://$1
nikto -Plugins 'ms10-070' -host https://$1 | cat > "$output_dir/nikto4.txt"
nikto -Plugins 'msgs' -host https://$1
nikto -Plugins 'outdated' -host https://$1
nikto -Plugins 'httpoptions' -host https://$1
nikto -Plugins 'cgi' -host https://$1 | cat > "$output_dir/nikto5.txt"
nikto -Plugins 'ssl' -host https://$1 | cat > "$output_dir/nikto-ssl.txt"
nikto -Plugins 'sitefiles' -host https://$1
nikto -Plugins 'paths' -host https://$1 | uro > "$output_dir/nikto6.txt"
echo
...
echo
cmsmap https://$1 -f W -F --noedb -v | cat > "$output_dir/cmsmap.txt"
echo
echo -e "\e[00;35m# Web security Scanner Sn1per #\e[00m" 
echo
su sn1per -t https://$1 -m stealth -o -re | cat > "$output_dir/sn1per.txt"
echo
echo -e "\e[00;35m# Attack of RMI with Barmie #\e[00m" 
echo
barmie -attack $1 80 | cat > "$output_dir/barmie.txt"
echo
